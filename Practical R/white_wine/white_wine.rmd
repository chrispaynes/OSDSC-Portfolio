...
# Translate numerical Quality Levels values
# into common quality descriptors terms
# and store the terms into quality_lev_f
...
# Factorize the newly created quality_lev_f strings
# and sort the levels in ascending quality order.
white_wine$quality_lev_f <- factor(white_wine$quality_lev_f,
                                   levels = c("below avg.",
                                              "avg.",
                                              "above avg.",
                                              "exceptional"))
...
# apply a range function to the vectors to reveal max and min column value
# and display those values for numerical vectors
colRange <- function(data) sapply(data, range, na.rm = FALSE)
t(colRange(white_wine[, sapply(white_wine, is.numeric)]))

# create a free-scaling boxplot for every column vector
...
ggplot(data = white_wine, aes(x = volatile.acidity)) +
  ...
  scale_x_continuous(
    ...
    limits = c(quantile(white_wine$volatile.acidity, probs = .005),
               quantile(white_wine$volatile.acidity, probs = .95))
  )
```
...
ggplot(data = white_wine, aes(x = citric.acid)) +
  ...
  scale_x_continuous(
    breaks = seq(0, max(white_wine$citric.acid), .1),
...
ggplot(data = white_wine, aes(y = chlorides)) +
  ...
  scale_y_continuous(
    breaks = seq(min(white_wine$chlorides),
                 quantile(white_wine$chlorides,
                          probs = 0.95),
                 0.01),
    limits = c(min(white_wine$chlorides),
               quantile(white_wine$chlorides,
                        probs = 0.999))
  )
```
...
ggplot(data = white_wine, aes(x = total.sulfur.dioxide)) +
  ...
  scale_x_continuous(breaks = seq(0,
                                  quantile(white_wine$total.sulfur.dioxide,
                                           probs = 0.999),
                                  20),
                     limits = c(0,
                                quantile(white_wine$total.sulfur.dioxide,
...
ggplot(data = white_wine, aes(x = density)) +
  ...
  scale_x_continuous(breaks = seq(
    min(white_wine$density),
    quantile(white_wine$density, probs = 0.95),
    0.001
  ),
  limits = c(
    min(white_wine$density),
...
ggplot(data = white_wine, aes(y = density)) +
  geom_boxplot(binwidth = 0.001,
               fill = "lightblue",
               color = "black") +
  scale_y_continuous(breaks = seq(
    min(white_wine$density),
    quantile(white_wine$density,
             probs = 0.95),
    0.001
  ),
  limits = c(
...
ggplot(data = white_wine, aes(x = pH)) +
  ...
  scale_x_continuous(
    ...
    limits = c(quantile(white_wine$pH, probs = 0.01),
               quantile(white_wine$pH, probs = 0.95))
  )
```
...
ggplot(data = white_wine, aes(x = alcohol)) +
  ...
  scale_x_continuous(
    ...
    limits = c(min(white_wine$alcohol),
               quantile(white_wine$alcohol, probs = 0.95))
  )
```
...
ggplot(data = white_wine, aes(y = alcohol)) +
  ...
  scale_y_continuous(
    breaks = seq(min(white_wine$alcohol),
                 quantile(white_wine$alcohol, probs = 0.95), 0.5),
    limits = c(min(white_wine$alcohol),
               quantile(white_wine$alcohol, probs = 0.999))
  )
```
...
ggplot(data = white_wine, aes(x = fixed_to_volatile_acid_level)) +
  ...
  scale_x_continuous(
    breaks = seq(0, quantile(white_wine$fixed_to_volatile_acid_level,
                             probs = 0.95), 5),
    limits = c(min(white_wine$fixed_to_volatile_acid_level),
               quantile(white_wine$fixed_to_volatile_acid_level,
                        probs = 0.95))
  )
```
...
ggplot(data = white_wine, aes(x = sugar_to_sulfates_ratio)) +
  ...
  scale_x_continuous(
    breaks = seq(0, quantile(white_wine$sugar_to_sulfates_ratio,
                             probs = 0.95), 1),
    limits = c(min(white_wine$sugar_to_sulfates_ratio),
               quantile(white_wine$sugar_to_sulfates_ratio, probs = 0.95))
  )
```
...
```{r}
# loop through all data.frame columns and create a linear model between
# the column and the quality column and then print a summary table of the
# adjusted R-Squared values for each column and the Quality column
...
data = white_wine
  ...
  scale_y_continuous(breaks = seq(0, 10)) +
  scale_x_continuous(
    breaks = seq(floor(min(white_wine$density)),
                 max(white_wine$density), 0.0025),
    limits = quantile(white_wine$density, probs = c(0, .99))
  ) +
  facet_wrap(~quality_lev_f, scales = "free") +
  guides(colour = guide_legend(title = "Density",
                               override.aes = list(alpha = 1))) +
  ggtitle("Wine Quality and Wine Density Distribution Averages")
```
...
data = white_wine
  ...
  facet_wrap(~quality_lev_f, scales = "free") +
  guides(colour = guide_legend(title = "Total Sulfur Dioxide",
                               override.aes = list(alpha = 1))) +
...
data = white_wine
  ...
  facet_wrap(~quality_lev_f, scales = "free") +
  guides(colour = guide_legend(title = "Chlorides",
                               override.aes = list(alpha = 1))) +
...
data = white_wine
  ...
  facet_wrap(~quality_lev_f, scales = "free") +
  guides(colour = guide_legend(title = "Volatile Acidity",
                               override.aes = list(alpha = 1))) +
...
data = white_wine
  ...
  scale_y_continuous(breaks = seq(0, 10)) +
  scale_x_continuous(breaks = seq(floor(min(white_wine$pH)),
                                  max(white_wine$pH), 0.1)) +
  facet_wrap(~quality_lev_f, scales = "free") +
...
ggplot(white_wine, aes(quality, citric.acid)) +
  geom_point(aes(colour = quality_lev_f, alpha = 1 / 20), position= position_jitter(width = 0.025, height = 0)) +
  ...
  guides(colour = guide_legend(title = "Wine Quality Levels",
                               override.aes = list(alpha = 1))) +
...
data = white_wine
  ...
  scale_x_continuous(breaks = seq(min(white_wine$quality),
                                  max(white_wine$quality), 1)) +
  scale_y_continuous(breaks = seq(floor(min(white_wine$pH)),
                                  max(white_wine$pH), 0.1)) +
...
data = white_wine
  ...
  geom_point(alpha = 1 / 20,
             aes(color = quality_lev_f),
             position = position_jitter(width = 0, height = .025)) +
    guides(colour = guide_legend(title = "Wine Quality Levels",
                                 override.aes = list(alpha = 1))) +
...
ggplot(aes(x = quality,
  ...
  scale_x_continuous(breaks = seq(min(white_wine$quality),
                                  max(white_wine$quality),
                                  1)) +
  scale_y_continuous(limits = quantile(white_wine$total.sulfur.dioxide,
                                       probs = c(0.01, 0.99))) +
...
```{r}
# Create a scatterplot and histogram (ScatterHist) for the relationship between
# wine quality numbers and alcohol. Apply a Linear Model smoothing trend.
WVPlots::ScatterHist(
  frame = white_wine,
  yvar = "alcohol",
  xvar = "quality",
...
```{r}
# Create a scatterplot and histogram for the relationship between
# wine quality factors and alcohol. Color the aesthetic by wine quality
# factors
ggMarginal(
  ggplot(
    data = white_wine,
    ...
    geom_point(position = position_jitter(width = 0.05, height = 0.1),
               alpha = 1/5) +
    guides(colour = guide_legend(title = "Wine Quality Levels",
                                 override.aes = list(alpha = 1))) +
    theme_bw(15),
...
```{r}
# Create a scatterplot and violin plot for the relationship between
# wine quality factors, alcohol and wine density for Below Average
# and Exceptional wines. Color the aesthetic by wine quality
# factors.
ggMarginal(
  ggplot(data = white_wine[white_wine$quality_lev_f
                           %in% c("below avg.", "exceptional"), ],
         aes(
           x = alcohol,
           y = density,
           colour = quality_lev_f
         ),) +
    geom_point(alpha = 1 / 3, position = position_jitter(height = 0)) +
    scale_x_continuous(breaks = seq(
    ...
    theme_bw(15) +
    ggtitle("Below Average and Exceptional Wine Quality",
...
```{r}
# Create a scatterplot and boxplot for the relationship between
# wine quality factors, Total Sulfur Dioxide and Chlorides for Below Average
# and Exceptional wines. Color the aesthetic by wine quality
# factors and limit both the X and Y axis by their 97th percentile values.
ggMarginal(
  ggplot(
    data = white_wine[white_wine$quality_lev_f
                      %in% c("below avg.", "exceptional"),],
    aes(x = total.sulfur.dioxide,
        y = chlorides,
        colour = quality_lev_f)
  ) +
    geom_point(position = position_jitter(), alpha = 1/3) +
    scale_x_continuous(
      breaks = seq(
    ...
    scale_y_continuous(limits = quantile(white_wine$chlorides,
                                         probs = c(0, 0.97)),) +
    guides(colour = guide_legend(
      title = "Wine Quality Levels", override.aes = list(alpha = 1)
    )) +
...
```{r}
# Create a scatterplot and boxplot for the relationship between
# wine quality factors, Total Sulfur Dioxide and Volatile Acidity for
# Below Average and Exceptional wines. Color the aesthetic by wine quality
# factors and limit both the X and Y axis by their 97th percentile values.
ggMarginal(
  ggplot(
    data = white_wine[white_wine$quality_lev_f
...
```{r}
# Create a scatterplot for the relationship between
# wine quality factors, pH and Citric Acid for Below Average and
# Exceptional wines. Color the aesthetic by wine quality
# factors and limit Citric Acid by its 97th percentile and limit pH by
# its 95th Percentile.
ggplot(white_wine[white_wine$quality_lev_f
                  %in% c("below avg.", "exceptional"), ],
       aes(pH, citric.acid)) +
  geom_point(aes(colour = quality_lev_f, alpha = 1 / 10),
             position = position_jitter()) +
  scale_y_continuous(limits = quantile(white_wine$citric.acid,
                                       probs = c(0.05, .97))) +
  scale_x_continuous(limits = quantile(white_wine$pH, probs = c(0.05, .95)),
                     breaks = seq(floor(min(white_wine$pH)),
                                  max(white_wine$pH), 0.1)) +
  theme(legend.position = c(0.1, 0.75)) +
...
and the Relationship Between pH and Citric Acid"
  )
```
...
```{r}
# Create a scatterplot for the relationship between
# wine quality, Alcohol and Wine Density for Below Average and
# Exceptional wines. Color the aesthetic by wine quality
# factors and increase the dot size based on the numerical quality value
# (larger quality values have larger dots than smaller quality values).
ggplot(white_wine[white_wine$quality_lev_f
                  %in% c("below avg.", "exceptional"),],
       aes(alcohol, density, color = quality_lev_f)) +
  geom_point(aes(size = quality),
             position = position_jitter(),
             alpha = 1 / 3) +
  scale_x_continuous(breaks = seq(floor(min(white_wine$alcohol)),
                                  max(white_wine$alcohol), 0.5)) +
  labs(x = "Alcohol", y = "Density") +
  guides(size = guide_legend(title = "Wine Quality Levels",
                             override.aes = list(alpha = 1))) +
  ggtitle(
    "Below Average and Exceptional Wine Quality
and the Relationship Between Alcohol and Wine Density"
  )
```
...
```{r}
# Create a scatterplot for the relationship between
# wine quality factors, Alcohol and Residual Sugar for Below Average and
# Exceptional wines. Color the aesthetic by wine quality factors and limit
# Residual Sugar by its 90th percentile and limit alcohol by
# its 95th Percentile.
ggplot(white_wine[white_wine$quality_lev_f
                  %in% c("below avg.", "exceptional"),],
       aes(alcohol, residual.sugar, colour = quality_lev_f)) +
  geom_point(position = position_jitter(),
             alpha = 1/2) +
  scale_y_continuous(limits = quantile(white_wine$residual.sugar,
                                       probs = c(0.1, 0.9)),) +
  scale_x_continuous(limits = quantile(white_wine$alcohol,
                                       probs = c(0.1, 0.95)),
                     breaks = seq(9.5, max(white_wine$alcohol), 0.5)) +
  labs(x = "Alcohol", y = "Residual Sugar") +
  guides(colour = guide_legend(title = "Wine Quality Levels",
                               override.aes = list(alpha = 1))) +
  ggtitle(
    "Below Average and Exceptional Wine Quality
and the Relationship Between Alcohol and Residual Sugar"
  )
```
...
```{r}
# Create scatterplots for the relationship between
# Alcohol and pH using a sequence
# of plot panels for each wine quality factor.
ggplot(data = white_wine, mapping = aes(y = pH, x = alcohol)) +
  geom_point(alpha = 1 / 10,
             color = "steelblue",
             position = position_jitter()) +
  labs(
    title = "Wine Quality with Alcohol and pH Cross Comparision",
    y = "pH Level",
    x = "Alcohol Level"
  ) +
...
```{r}
# Create scatterplots for the relationship between
# Residual Sugar and pH using a sequence
# of plot panels for each wine quality factor.
# Limit Residual Sugar to the 99th Percentile.
ggplot(
  data = white_wine,
...
```{r}
# Create scatterplots for the relationship between
# Alcohol and Residual Sugar using a sequence
# of plot panels for each wine quality factor.
# Limit Residual Sugar to the 99th Percentile.
ggplot(
  data = white_wine,
...
```{r}
# Create scatterplots for the relationship between
# Residual Sugar and Total Sulfur Dioxide using a sequence
# of plot panels for each wine quality factor.
# Limit Residual Sugar to the 99th Percentile.
ggplot(data = white_wine,
       mapping = aes(y = residual.sugar, x = total.sulfur.dioxide)) +
  geom_point(alpha = 1 / 10, color = "steelblue",
             position = position_jitter()) +
  ylim(quantile(white_wine$residual.sugar, probs = c(0, .99))) +
  labs(
    title = "Wine Quality with Residual Sugar and
Total Sulfur Dioxide Cross Comparison",
    y = "Residual Sugar",
    x = "Total Sulfur Dioxide"
  ) +
  facet_wrap( ~ quality_lev_f, ncol = 2)
...
data = white_wine
  ...
  labs(y = "Wine Quality", x = "Chlorides (g / dm^3^)") +
  facet_wrap(~quality_lev_f, scales = "free") +
  guides(colour = guide_legend(title = "Chlorides (g/dm^3^)",
                               override.aes = list(alpha = 1))) +
  ggtitle("Wine Quality and Chlorides Distribution Averages")
```
...
ggMarginal(
  ggplot(
    ...
    scale_x_continuous(
      ...
      limits = quantile(white_wine$total.sulfur.dioxide,
                        probs = c(0, 0.97)),
    ) +
    scale_y_continuous(limits = quantile(white_wine$volatile.acidity,
                                         probs = c(0, 0.97)), ) +
    guides(colour = guide_legend(
      title = "Wine Quality Levels", override.aes = list(alpha = 1)
    )) +
